            ...
            <div class="center-inner">
                ...
                <div class="form-wrapper">
                    <div class="row tabs-container" id="tab_1" style="display:block">
                        <form action="{{route('admin.submit_client')}}" class="business" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        ...
                                        <input type="hidden"  name="usertype" id="usertype" value="agent" class="input-class">
                                        <input type="hidden"  name="newid" id="newid" value={{$new_id}} class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 col-sm-3"> <span class="element-name">Social Security :</span></div>
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 col-sm-3"> <span class="element-name">Birthday : </span></div>
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text" class="input-class" name="birthday" id="birthday" data-toggle="datepicker" placeholder="MM/DD/YYYY">
                                    </div>
                                </div>
                            </div>

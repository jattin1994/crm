            ...
            <div class="center-inner clearfix">
                <nav class="agent-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li  class="breadcrumb-item1" style="float: right;content: none !important;font-size: 24px;font-weight: 600;margin: 0 25px 0 0;position: relative;padding: 0 0 0 35px;"><a href="{{route('admin.add_newsale',$data->id)}}"><button class="btn custom-btn pull-right fill editsale">Add New Sale</button></a></li>
                    </ol>
                </nav>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                                <div class="details-heads clearfix">
                                    <span class="name">{{ucfirst($data->name)}}</span>
                                ...
                                <div class="row sales-view-details">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                        <span class="text">{{$data->address1}} </span>
                                    </div>
                                    @endif
                            <div class="pp-details clearfix">
                                ...
                                <a href="{{route('admin.add_clientbanking',Request::segment('3'))}}"><button type="button" class="custom-btn fill mr15">Add Client Banking Details</button></a>
                                </div>
                                @else
                                <div class="row sales-view-details">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <span class="text">{{ucfirst($data->clientbank->bankname)}}</span>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label>Bank Address:</label>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <span class="text">{{($data->clientbank->bankaddress)}}</span>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label>Routing Number.:</label>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <span class="text">****{{substr($data->clientbank->routingno,-4)}}</span>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label>Account Holder Name:</label>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <span class="text">{{ucfirst($data->clientbank->accountholdername)}}</span>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label>Account Number:</label>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <span class="text">****{{substr($data->clientbank->accoutnumber,-4)}}</span>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label>Account Type:</label>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <span class="text">{{ucfirst($data->clientbank->accounttype)}}</span>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="btn-wrap">
                                                    <a href="#" data-toggle="modal" data-dismiss= "modal" data-target="#delete_clientaccountdetail" class="login_modal_forgot"><button type="button" class="custom-btn mr15">Delete Bank</button></a>
                                                    <a href="{{route('admin.editclient_account',$data->clientbank->businessid)}}" class="login_modal_forgot"><button type="button" class="custom-btn mr15">Edit Bank Detail</button></a>
                                                </div>

<!-- for delete bank detail -->
<div class="modal fade modal-center bd-example-modal-lm forgot" id="delete_clientaccountdetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
        ...
        <div class="modal-content" style="width: 470px;">
            <div class="modal-body" style="padding: 15px 15px 0px;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 ...
                 <h2 class="heading withicon"><img class="icon" src="{{URL::asset('theme/assets/images/briefcase.svg')}}" alt=""> Client Account Delete </h2>
                 
                 <h6>Are You want to delete the Client Bank detail?</h6>
                       <form class="login_modal forgot_password" action="{{url('/admin/delete_clientbankdetail')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}

                            <input type="hidden" name="businessid" value="{{$data->clientbank->businessid}}">
                    ...
                    <div class="stickyTable" style="overflow-x: unset!important;">
                        <table id="example1"  class="table outlet-table shortingTable sticky-enabled notifications-table table-responsive no-padding video-list1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{route('admin.sales_detail',$d->id)}}" class="cname">{{($d->id)}}</a></td>
                                    <td >{{($d->amount)}}</td>
                                    <td>{{$d->type}}</td>
                ...
                <div class="sales-view-tab-container" id="uploaddoc">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                                ...
                                <a href="{{route('admin.client_file', $data->id)}}"><button type="button" class="btn custom-btn pull-right editsale">Upload Files</button></a>
            ...
            <div class="modal-body" style="padding: 15px 15px 0px;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                 ...
                 <h6>Are you want to delete this file?</h6>
                       <form class="login_modal forgot_password" action="{{url('/admin/client_filedelete')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}

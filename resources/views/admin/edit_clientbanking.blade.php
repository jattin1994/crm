            ...
            <div class="center-inner clearfix">
                ...
                <div class="form-wrapper">
                    ...
                    <div class="row tabs-container" id="tab_2" style="display:block">
                        <form action="{{route('admin.update_clientbankingdetail')}}" method="post" class="referal">
                            {{csrf_field()}}
                            <div class="form-group">
                                <div class="col-xs-12 col-sm-3"> <span class="element-name">Bank Name :</span></div>
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="bankname"  id="bankname" value="{{$data->bankname}}" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="bankaddress" id="bankaddress" value="{{$data->bankaddress}}" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="routingno" id="routingno" value="{{$data->routingno}}" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text" name="accountholdername" id="accountholdername" value="{{$data->accountholdername}}" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="accoutnumber" id="accoutnumber" value="{{$data->accoutnumber}}" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="accounttype" id="accounttype" class="input-class" value="{{$data->accounttype}}">

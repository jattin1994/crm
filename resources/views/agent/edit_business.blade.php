            ...
            <div class="center-inner">
                ...
                <div class="form-wrapper">
                    <div class="row tabs-container" id="tab_1" style="display:block">
                        <form action="{{route('agent.update_business')}}" class="business" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="email" name="email" value="{{$data->email}}" id="email" class="input-class">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text" class="input-class" id="birthday" placeholder="MM/DD/YYYY" name="birthday" data-toggle="datepicker" value="{{$data->birthday}}">
                                    </div>
                                </div>
                            </div>

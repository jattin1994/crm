            ...
            <div class="center-inner">
                ...
                <div class="form-wrapper">
                    ...
                    <div class="row tabs-container" id="tab_2" style="display:block">
                        <form action="{{route('agent.add_saleamount')}}" class="editbusiness1" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="inputfield-wrap qualified-radio radio-btn">
                                        <label class="radio-inline"><input type="radio" value="Qualified" id="Qualified" checked="" name="optradio">Qualified</label>
                                        <label class="radio-inline"><input type="radio" value="Non-Qualified"  name="optradio" id="non">Non-Qualified</label>
                                    </div>
                                </div>
                            </div>
                            <div id="qualified" class="qual-non-qual-wrap" style="display:block;">
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-3"> <span class="element-name">Custodian name : </span></div>
                                    <div class="col-xs-12 col-sm-5">
                                        <div class="input-wrap">
                                            <select name="custodian" id="qual-custodian" class="selectpicker" required=""> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                        <div class="input-wrap">
                                            <select name="account_type" id="qual-account-type" class="selectpicker" required="">
                                                <option value="">Select an option</option>        
                            ...
                            <div id="Non-Qualified" class="qual-non-qual-wrap">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                        <div class="input-wrap">
                                            <select name="funding" id="non-qualfundingm" class="selectpicker" required="">
                                                <option value="">Select an option</option>
                            ...
                            <div class="btn-wrap col-sm-12">
                                <a href="javascript:history.go(-1)"><button type="button" class="custom-btn mr15 btn-right-space">Cancel</button></a>
                                <a href="{{route('agent.add_newsale',$id)}}"><button type="button" class="custom-btn fill arrow">

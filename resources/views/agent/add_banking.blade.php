            ...
            <div class="center-inner clearfix">
                ...
                <div class="form-wrapper">
                    ...
                    <div class="row tabs-container" id="tab_2" style="display:block">
                        <form action="{{route('agent.submit_bankingdetail')}}" method="post" class="referal">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="bankaddress1" id="bankaddress2" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <div class="input-wrap">
                                        <input type="text"  name="bankaddress2" id="bankaddress2" class="input-class">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
